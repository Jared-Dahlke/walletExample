...
const navigation = [
	...
	{ name: 'Wallets', href: '#', icon: WalletIcon, current: false },
	{ name: 'Devices', href: '#', icon: DeviceTabletIcon, current: false },
...
const cards = [
	{ name: 'Account balance', href: '#', icon: ScaleIcon, amount: '6.15' }
	// More items...
]
const transactions = [
	{
